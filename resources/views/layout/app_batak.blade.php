...
<body>
        ...
        <div class="humberger__menu__widget">
            <div class="header__top__right__language">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('dashboard-batak') }}}">Batak</a></li>
                </ul>
            </div>
            <div class="header__top__right__auth">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    <li><a class="dropdown-item" href="{{ route('user.profile') }}">Poropil</a></li>
                    <li> <a class="dropdown-item" href="{{ route('logout') }}">Haruar</a></li>
                </ul>
            </div>
        </div>
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                <li><a href="/">Emper</a></li>
                <li><a href="/product">Balanjo Situhoron</a></li>
                {{-- <li><a href="#">Pages</a>
    ...
    <header class="header" >
        <div class="header__top"style="background-image: url({{ asset('img/bg/bg.jpg') }}); background-size: 80px 48px">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            <div class="header__top__right__social">
                                <a href="#">Boa-boa</a>
                                <a href="{{ route('faq') }}">Pangurupion</a>
                            </div>
                            <div class="header__top__right__language">
                                <img src="img/language.png" alt="">
                                <div>Indonesia</div>
                            ...
                            <div class="header__top__right__auth">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    <a class="dropdown-item" href="{{ route('user.profile') }}">Poropil</a>
                                    <a class="dropdown-item" href="{{ route('logout') }}">Haruar</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form method="post" action="{{ route('search') }}">
                                @csrf
                                <input type="text" name="keyword" placeholder="Aha do na dijalahi muna?">
                                <button type="submit" class="site-btn">JALAHI</button>
                            </form>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            ...
                            <li>Nomor HP: +62 822-1323-9041</li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 offset-lg-1">
                    <div class="footer__widget">
                        <h6>Link</h6>
                        <ul>
                            <li><a href="#">Tarisingot tu hami</a></li>
                            <li><a href="#">Parsadaan HKBP</a></li>
                            <li><a href="#">Panuratan ni anggota</a></li>
                            <li><a href="#">Surirang Pangirimon</a></li>
                            <li><a href="#">Peraturan ni hadameon</a></li>
                            <li><a href="#">Anggota nami</a></li>
                        </ul>
                        <ul>
                            <li><a href="#">Pangurupion</a></li>
                            <li><a href="#">Hobason</a></li>
                            <li><a href="#">pasitik</a></li>
                            <li><a href="#">Testimoni</a></li>
                            <li><a href="#">akk gobbaran</a></li>
                            <li><a href="#">Tarsiongot tu HKBP</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script>Kelompok 12 TA 2022</p>
                </div>
            </div>
        </div>
    </footer>
