                ...
                <div class="login_form mb-5">
                    <form action="{{ route('registerSellerPost') }}" method="post">
                        ...
                        <div class="input-group">
                            <input type="text"  name="nama_toko" class="form-control mb-4" placeholder="Nama Toko">
                        </div>
                        <label for="store-name" class="form-label">NIK</label>
                        <div class="input-group">
                            <input type="text"  name="nik" class="form-control mb-4" placeholder="NIK">
                        </div>
                        ...
                        <button type="submit" class="btn btn-md w-100 mb-4" style="background-color: #25AF22; color:white">Register</button>
