            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 p-4 text-center">
                        <a href="{{ route('faq.show') }}">
                            <div class="box p-5" style="border: 2px solid rgba(0, 0, 0, 0.8)">
                                <h4>Belanja di toko</h4>
                            </div>
                        </a>
                    </div>
                    <div class="col-md-4 p-4 text-center">
                        <div class="box p-5" style="border: 2px solid rgba(0, 0, 0, 0.8)">
                            <h4>Pengembalian Dana & Barang</h4>
                        </div>
                    </div>
                    <div class="col-md-4 p-4 text-center">
                        <div class="box p-5" style="border: 2px solid rgba(0, 0, 0, 0.8)">
                ...
                <div class="row my-3">
                    ...
                    <ul style="list-style: none; ">
                        <li style="font-size:18px;" class="m-3">[Pengembalian Barang/Dana] Apa saja tips pengumpulan bukti pengembalian barang atau dana?</li>
                        <li style="font-size:18px;" class="m-3">[Pajak Penjual] Apakah penjual perlu membayar pajak berjualan pada aplikasi?</li>
                        <li style="font-size:18px;" class="m-3">Bagaimana cara untuk mulai berjualan pada aplikasi ini?</li>
                        <li style="font-size:18px;" class="m-3">[Pembatalan Pesanan] Dapatkah saya membatalkan pesana saya?</li>
                        <li style="font-size:18px;" class="m-3">[Pengiriman] Dimana saya dapat melacak keberadaan pesanan saya?</li>
                        <li style="font-size:18px;" class="m-3">[Pajak Penjual] Apakah penjual perlu membayar pajak berjualan pada aplikasi?</li>
                        <li style="font-size:18px;" class="m-3">[Bayar di Tempat] Apa itu pembayaran ditempat?</li>
                    </ul>
                </div>
            </div>
        </section>
