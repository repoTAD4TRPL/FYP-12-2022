                                        ...
                                        <div class="col-10">
                                            <table>
                                                ...
                                                <tr>
                                                    <td>Total Harga</td>
                                                    <td class="px-3"> : </td>
                                                    <td>Rp250.000 <span style="text-decoration: line-through; font-size:0.9em; color:rgb(204, 19, 19);" class="px-3">Rp280.000</span></td>
                                                </tr>
                                            </table>
                                            <hr>
                                            <div class="row my-3">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <h5 style="text-decoration:line-through; color:rgb(204, 19, 19); ">Rp280.000</h5>
                                                </div>
                                                <div class="col-6">
                                                    <h5 style="text-decoration:none; color:rgb(0, 0, 0); ">Rp250.000</h5>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-6 text-center">
                                                    <a href="{{ route('pemesanan') }}" style="border: solid 0.5px #cccc" class="btn btn-light w-100">Tolak</a>
                                                </div>
                                                <div class="col-6 text-center">
                                                    <a href="{{ route('pemesanan.detail-disetujui') }}" class="btn btn-primary w-100">Terima</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
